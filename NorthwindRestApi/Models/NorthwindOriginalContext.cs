...
namespace NorthwindRestApi.Models
{
    public partial class NorthwindOriginalContext : DbContext
    {
        ...
        public virtual DbSet<OrderSum> OrderSums { get; set; } = null!;
        ...
        public virtual DbSet<ProductsSum> ProductsSums { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=NIKOKOULU;Database=NorthwindOriginal;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Article>(entity =>
            {
                ...
                entity.HasOne(d => d.Category)
                    ...
                    .HasConstraintName("FK__Articles__Catego__09A971A2");
            });
            ...
            modelBuilder.Entity<LoanDetail>(entity =>
            {
                ...
                entity.HasOne(d => d.Article)
                    ...
                    .HasConstraintName("FK_LoanDetails_Articles");
